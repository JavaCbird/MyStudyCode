/*
 * 功能:在版本11基础上优化某些代码:修改hitTank()函数,将击中敌方坦克与击中我的坦克分别封装成函数hitEnemyTank()与hitMyTank()
 * 遇到的问题:击中敌方坦克后,有爆炸效果,坦克却不消失.修改方法:将EnemyTank类中的Boolean isLive=true的定义删除,使其直接继承Tank类中的isLive变量
 */
package com.tankgame_12;
...
public class MyTankGame_12 extends JFrame{
